              ...
              <div className="text-2xl font-semibold">
                {
                  Object.keys(stats.byType).filter(
                    k => stats.byType[k as Mem0ryType] > 0
                  ).length
                }
              </div>
            </div>
